...
import PayPalButton from "./PayPalButton"; // đường dẫn tương đối tùy vào vị trí
...
const Cart = () => {
    ...
    const placeOrder = async () => {
        if (paymentOption === "COD") {
            // xử lý đơn hàng COD tại đây
            alert("Đơn hàng COD đã được đặt thành công!");
        }
    };
    const handlePaymentSuccess = (details) => {
        console.log("Thanh toán thành công:", details);
        alert(`Cảm ơn ${details.payer.name.given_name}, thanh toán thành công!`);
        // Gửi đơn hàng về server ở đây nếu cần
    };
    ...
    <div className="mt-6">
        <PayPalButton 
            total={getCartAmount() + getCartAmount() * 0.02} 
